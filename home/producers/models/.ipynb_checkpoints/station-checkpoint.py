...
class Station(Producer):
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        logger.info(f"Start producing arrival message by topic {self.topic_name} for KAFKA")
        ...
        logger.info(f"Arrival message by topic {self.topic_name} for KAFKA is produced")
